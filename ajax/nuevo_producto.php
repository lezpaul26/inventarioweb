...
include('is_logged.php');
	if (empty($_POST['codigo'])) {
           $errors[] = "Código vacío";
			...
			$errors[] = "La ubicación del producto esta vacío";
		}
		 else if ($_POST['stock']==""){
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, date_added, precio_producto, stock, id_categoria, ubicacion) VALUES ('$codigo','$nombre','$date_added','$precio_venta', '$stock','$id_categoria','$ubicacion')";
