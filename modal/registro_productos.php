			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				 ...
				 <div class="form-group">
				<label for="nombre" class="col-sm-3 control-label">Ubicación</label>
				<div class="col-sm-8">
					<textarea class="form-control" id="nombre" name="ubicacion" placeholder="Ubicación del producto" required maxlength="255" ></textarea>
